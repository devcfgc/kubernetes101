...
Add a readiness and liveness probe healthchecks.
...
```
kubectl describe po helloworld-deployment-with-bad-readiness-probe-8664db7448-pv4fm
...
```
kubectl describe po helloworld-deployment-with-bad-liveness-probe-77759fbbbf-kljs4
